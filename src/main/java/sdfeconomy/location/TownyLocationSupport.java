...
/**
 * Acts as a proxy adding support for Towny account names which do not provide location information. Towny accounts have
 * a location separate from all other economy accounts.
 */

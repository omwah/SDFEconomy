...
/**
 * Time the speed of the current commit functionality Grinders + ecoCreature can queue up a large number of writes and
 * cause excessive disk i/o if not handled properly
 */
